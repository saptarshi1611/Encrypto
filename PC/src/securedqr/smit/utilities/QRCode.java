...
public class QRCode {	
  ...
  */
  public static String genQRCode(String[] args) throws Exception  {		
    ...
    data=readFromFile(data);  //if this exceeds ~4.2KB with low error correction level then Exception will occur    
